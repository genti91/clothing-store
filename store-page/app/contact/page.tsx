  ...
  <div className="container mx-auto">
    <div className="-mx-4 flex flex-wrap lg:justify-between">
      <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div className="mb-12 max-w-[620px] lg:mb-0">
          {/* <span className="text-[#d6ccc2] mb-4 block text-base font-semibold">
            Contact Us
          </span> */}
          <h2
          ...
          <div className="mb-8 flex w-full max-w-[370px]">
            <div
              className="bg-[#d6ccc2] text-[#d6ccc2] mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
            >
              <svg
                width="24"
                height="24"
      ...
      <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
        <div className="relative rounded-lg bg-white p-8 shadow-lg border sm:p-12">
          <form>
            <div className="mb-6">
              <input
                type="text"
                placeholder="Your Name"
                className="text-body-color border-[f0f0f0] focus:border-[#d6ccc2] w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
              />
            </div>
            <div className="mb-6">
              <input
            ...
            <div className="mb-6">
              <textarea
                ...
                className="text-body-color border-[f0f0f0] focus:border-[#d6ccc2] w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
              ></textarea>
            </div>
            <div>
              <button
                type="submit"
                className="bg-[#d6ccc2] border-[#d6ccc2] w-full rounded border p-3 text-white transition hover:bg-opacity-90"
              >
                Send Message
              </button>
            </div>
